...
第一个迪利克雷分布是“文档-主题分布”，它对应一个控制参数α，这个分布可以看作一个多边形（多面体），每一个顶点对应一个主题，多面体内含有多个点，对应多个文档，点到某个顶点的距离可以理解为文档对应这个主题的概率，距离越近，概率越大。其次是参数α，当α=1时，对应随机分布；当α<1时，各个点趋向于接近顶点，也就是我们需要的效果；当α>1时，各个点趋向于中心聚拢。  
